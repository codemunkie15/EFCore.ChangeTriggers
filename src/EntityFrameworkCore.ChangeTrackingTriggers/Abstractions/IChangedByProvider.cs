namespace EntityFrameworkCore.ChangeTrackingTriggers.Abstractions
{
    ...
    /// </summary>
    /// <typeparam name="TChangedBy">The changed by type (either a static value e.g. a username string, or the foreign key to an EF Core entity).</typeparam>
    public interface IChangedByProvider<TChangedBy>
    {
        /// <summary>
        /// Gets the value of who changes are made by.
        /// </summary>
        /// <returns>Either a static value e.g. a username string, or the foreign key to an EF Core entity.</returns>
