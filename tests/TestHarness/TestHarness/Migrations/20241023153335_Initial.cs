    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateChangeTrigger(
                ...
                triggerName: "Permissions_GlobalCustomTriggerName",
            ...
            migrationBuilder.InsertData(
                table: "UserChanges",
                columns: new[] { "ChangeId", "ChangeSource", "ChangedAt", "ChangedById", "DateOfBirth", "Id", "Name", "OperationTypeId", "PrimaryPaymentMethodId" },
                values: new object[] { 50, "Migration", new DateTimeOffset(new DateTime(2024, 10, 23, 15, 33, 34, 839, DateTimeKind.Unspecified).AddTicks(2871), new TimeSpan(0, 0, 0, 0, 0)), 1, "Test", 1, "Test", 1, null });
