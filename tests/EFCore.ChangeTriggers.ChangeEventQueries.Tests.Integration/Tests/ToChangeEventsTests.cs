...
{
    public class ToChangeEventsTests : TestBase<TestDbContext>, IClassFixture<ToChangeEventsTestFixture>
    {

        public ToChangeEventsTests(ToChangeEventsTestFixture fixture) : base(fixture.Services)
        {
        }
        ...
        [Fact]
        public void ToChangeEvents_WithDbContextConfiguration_ReturnsCorrectChangeEvents()
        {
